...
export const GapFlagged: Story = {
  args: {
    flag: "Gap flagged",
    children:
      "§630h Abs. 1 BGB is the category that most directly covers this incident. No confirmed published German case matching this category was found in this corpus. The gap is shown, not hidden.",
  },
};
